  ...
  const userCategories = [
    {
      ...
      icon: <IoIosPersonAdd className="w-8 h-8" />,
    ...
    },
    {
      ...
      description: "Manage Unverified Customers records ",
          ...
          <div className="p-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Use the Customer directory to manage Customer Information, update customer information all in one place.</p>
                <p className="text-slate-700">Use the Customer directory to manage Unverified Customers Information, update customer information all in one place.</p>
              </div>
            </div>
          </div>
          </div>
