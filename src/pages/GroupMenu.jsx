          ...
          <div className="p-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Use the Group directory to manage Groups, update Group information all in one place. </p>
                <p className="text-slate-700">Use the Mobile Access directory to display groups based on the app selection. </p>
              </div>
            </div>
          </div>
          </div>
